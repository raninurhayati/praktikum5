...
Alur algoritma
    ...
    Mendeklarasikan variabel int sum(int a,int b); sebagai variable input.

    Membaca input dari keyboard cin >> a >> b;

    Membandingkan nilai variable int a, b; cin >> a >> b; cout << sum(a, b);
...
Alur algoritma
    ...
    Mendeklarasikan variabel void terbesar,urut_data; sebagai variable input.
    Membaca input dari keyboard cin >> a
    Membandingkan nilai variable cout << "Nilai terbesar adalah: " << max; cout << "\n\n";
